...
iCiteR is not yet on [CRAN](https://CRAN.R-project.org), but will soon be (hopefully!)

In the meantime, you can install the development version from [GitHub](https://github.com/) with:

...
The iCiteR package is a minimal R package designed to help users retrieve data from the NIH's [iCite API](https://icite.od.nih.gov/api). 

## Installation

You can install the released version of iCiteR from [CRAN](https://CRAN.R-project.org) with:
